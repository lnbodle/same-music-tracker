...
LIBS = -lc -L${SYSROOT}/usr/lib -lSDL -lSDL_ttf

# flags
CPPFLAGS = -DVERSION=\"${VERSION}\" -fPIC
CFLAGS += -Os ${INCS} ${CPPFLAGS} -fPIC -std=gnu11 -marm -mtune=cortex-a9 -mcpu=cortex-a9 -march=armv7-a -mfpu=neon-fp16 -mfloat-abi=softfp -flto
